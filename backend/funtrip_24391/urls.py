"""funtrip_24391 URL Configuration
...
admin.site.site_header = "Funtrip"
admin.site.site_title = "Funtrip Admin Portal"
admin.site.index_title = "Funtrip Admin"

# swagger
api_info = openapi.Info(
    title="Funtrip API",
    default_version="v1",
    description="API documentation for Funtrip App",
)
